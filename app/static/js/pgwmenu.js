...
;(function($){
    $.fn.pgwMenu = function(options) {
        ...
        var init = function() {
            ...
            // Merge user options with default configuration默认用户选项与缺陷配置
            ...
            // Resize trigger调整触发增加延时器让代码延缓执行。
            ...
            pgwMenu.plugin.find('.pm-dropDown').click(function(e) {
                ...
                e.stopPropagation();//指定要操作的元素的click事件停止传播
            });
        ...
        var setup = function() {
            ...
            pgwMenu.plugin.removeClass().addClass('pm-links');//移除并添加类
